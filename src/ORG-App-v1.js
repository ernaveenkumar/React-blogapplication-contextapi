...
function App() {
  ...
  return (
    //2nd step Use component here and provide value to child components
...
function Header() {
  ...
  //Use context here and destructure to use only the part we want to use. Pass the context object
...
//Give the value from the context
